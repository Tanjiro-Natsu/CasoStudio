...
public class MenuSearch extends JMenuBar{
	...
	public MenuSearch(final JTextArea d) {
		...
		k.add(f18);
		k5.add(Save);
		z111.addActionListener(e-> {d.setBackground(q1);});
		z22.addActionListener(e-> {d.setBackground(q2);});
		z33.addActionListener(e-> {d.setBackground(q3);});
		z44.addActionListener(e-> {d.setBackground(q4);});
		z55.addActionListener(e-> {d.setBackground(q5);});
		z66.addActionListener(e-> {d.setBackground(q6);});
		z77.addActionListener(e-> {d.setBackground(q7);});
		z88.addActionListener(e->{d.setBackground(q8);});
		z99.addActionListener(e->{d.setBackground(q9);});
		z101.addActionListener(e->{d.setBackground(q10);});
		z110.addActionListener(e-> {d.setBackground(q11);});
		z121.addActionListener(e-> {d.setBackground(q12);});
		z1.addActionListener(e-> {d.setForeground(q1);});
		z2.addActionListener(e->{d.setForeground(q2);});
		z3.addActionListener(e-> {d.setForeground(q3);});
		z4.addActionListener(e-> {d.setForeground(q4);});
		z5.addActionListener(e-> {d.setForeground(q5);});
		z6.addActionListener(e-> {d.setForeground(q6);});
		z7.addActionListener(e-> {d.setForeground(q7);});
		z8.addActionListener(e->{d.setForeground(q8);});
		z9.addActionListener(e-> {d.setForeground(q9);});
		z10.addActionListener(e-> {d.setForeground(q10);});
		z11.addActionListener(e-> {d.setForeground(q11);});
		z12.addActionListener(e-> {d.setForeground(q12);});
		Standard.addActionListener(e-> {sss=r;d.setFont(sss);});
		...
		Save.addActionListener(e-> {Save(d.getText());});
		...
		k.addActionListener(null);
		k4.addActionListener(null);
		k2.addActionListener(null);
		k3.addActionListener(null);
		k4.addActionListener(null);
		k5.addActionListener(null);
		add(k5);
		add(k);
		add(k4);
		add(k2);
	...
	public void Save(final String a) {
		...
		y21.addActionListener(e->{t.setText("");});
