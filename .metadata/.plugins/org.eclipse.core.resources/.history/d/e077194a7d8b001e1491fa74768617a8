...
public class MenuWriter extends JMenuBar{
	...
	public MenuWriter(final JTextPane d) {
		...
		DIALOG.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {yo=s1;sss=new Font(s1,yo1,yo2);d.setFont(sss);}});
		DIALOG_INPUT.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {yo=s2;sss=new Font(s2,yo1,yo2);d.setFont(sss);}});
		MONOSPACE.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {yo=s3;sss=new Font(s3,yo1,yo2);d.setFont(sss);}});
		SANS_SERIF.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {yo=s4;sss=new Font(s3,yo1,yo2);d.setFont(sss);}});
