...
public class MenuWriter extends JMenuBar{
	...
	public MenuWriter(final JTextPane d) {
		...
		f1.addActionListener( e-> {d.setFont(new Font(yo,yo1,10));});
		f2.addActionListener(e-> {d.setFont(new Font(yo,yo1,12));});
		f3.addActionListener(e-> {d.setFont(new Font(yo,yo1,14));});
		f4.addActionListener(e-> {d.setFont(new Font(yo,yo1,16));});
		f5.addActionListener(e-> {d.setFont(new Font(yo,yo1,18));});
		f6.addActionListener(e-> {d.setFont(new Font(yo,yo1,20));});
		f7.addActionListener(e-> {d.setFont(new Font(yo,yo1,22));});
		f8.addActionListener(e-> {d.setFont(new Font(yo,yo1,26));});
		f9.addActionListener(e->{d.setFont(new Font(yo,yo1,30));});
		f10.addActionListener(e-> {d.setFont(new Font(yo,yo1,34));});
		f11.addActionListener(e-> {d.setFont(new Font(yo,yo1,38));});
		f12.addActionListener(e-> {d.setFont(new Font(yo,yo1,40));});
		f13.addActionListener(e-> {d.setFont(new Font(yo,yo1,42));});
		f14.addActionListener(e-> {d.setFont(new Font(yo,yo1,44));});
		f15.addActionListener(e-> {d.setFont(new Font(yo,yo1,48));});
		f16.addActionListener(e-> {d.setFont(new Font(yo,yo1,50));});
		f17.addActionListener(e-> {d.setFont(new Font(yo,yo1,55));});
		f18.addActionListener(e-> {d.setFont(new Font(yo,yo1,60));});
		Standard.addActionListener(e-> {sss=r;d.setFont(sss);});
		DIALOG.addActionListener(e-> {d.setFont(new Font(s1,yo1,yo2));});
		DIALOG_INPUT.addActionListener(e-> {d.setFont(new Font(s2,yo1,yo2));});
		MONOSPACE.addActionListener(e-> {d.setFont(new Font(s3,yo1,yo2));});
		SANS_SERIF.addActionListener(e->{d.setFont(new Font(s3,yo1,yo2));});
		SERIF.addActionListener(e-> {d.setFont(new Font(s5,yo1,yo2));});
		y111.addActionListener(e-> {d.setFont(new Font(yo,yo1,yo2));});
		y112.addActionListener(e-> {d.setFont(new Font(yo,y2,yo2));});
		y113.addActionListener(e->{d.setFont(new Font(yo,y3,yo2));});
		y114.addActionListener(e-> {d.setFont(new Font(yo,y4,yo2));});
		y115.addActionListener(e-> {d.setFont(new Font(yo,y5,yo2));});
		y116.addActionListener(e-> {d.setFont(new Font(yo,y6,yo2));});
		y117.addActionListener(e-> {d.setFont(new Font(yo,y7,yo2));});
		y118.addActionListener(e-> {d.setFont(new Font(yo,y8,yo2));});
		y119.addActionListener(e-> {d.setFont(new Font(yo,y9,yo2));});
		y120.addActionListener(e-> {d.setFont(new Font(yo,y10,yo2));});
		y121.addActionListener(e-> {d.setFont(new Font(yo,y11,yo2));});
		y122.addActionListener(e-> {d.setFont(new Font(yo,y12,yo2));});
		add(k);
		add(k4);
		add(k2);
		add(k3);
